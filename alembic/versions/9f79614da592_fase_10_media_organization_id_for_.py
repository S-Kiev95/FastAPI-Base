"""fase 10: media organization_id for storage policies

Revision ID: 9f79614da592
Revises: f9173237d647
Create Date: 2026-04-05 19:35:08.956569
...
revision: str = '9f79614da592'
down_revision: Union[str, Sequence[str], None] = 'f9173237d647'
...
def upgrade() -> None:
    ...
    op.add_column('media', sa.Column('organization_id', sqlmodel.sql.sqltypes.AutoString(), nullable=True))
